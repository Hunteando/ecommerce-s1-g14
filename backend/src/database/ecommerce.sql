...
CREATE TABLE `productos` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_marcas_id_idx` (`marca_id`),
  KEY `FK_categorias_id_idx` (`categoria_id`),
  CONSTRAINT `FK_categorias_id` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `FK_marcas_id` FOREIGN KEY (`marca_id`) REFERENCES `marcas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-02  1:45:12
